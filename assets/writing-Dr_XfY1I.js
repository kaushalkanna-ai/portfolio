import{c as e}from"./index-DYQfDV4T.js";import{Z as t}from"./zap-DdWsA_lQ.js";import{C as o}from"./code-CksvJQOZ.js";const i=[["path",{d:"M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z",key:"p7xjir"}]],n=e("cloud",i);const a=[["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2",key:"1yyitq"}],["path",{d:"M16 3.128a4 4 0 0 1 0 7.744",key:"16gr8j"}],["path",{d:"M22 21v-2a4 4 0 0 0-3-3.87",key:"kshegd"}],["circle",{cx:"9",cy:"7",r:"4",key:"nufk8"}]],s=e("users",a),h=[{id:1,title:"Scaling Engineering Teams from 5 to 50",summary:"Lessons learned in culture, process, and hiring during a period of hyper-growth. How to maintain velocity without sacrificing quality.",date:"Dec 12, 2025",readTime:"8 min read",slug:"scaling-engineering-teams",tags:["Leadership","Scaling","Culture"],icon:s,link:"#",color:"from-violet-500 to-fuchsia-500",keyTakeaways:["At 50 engineers, information osmosis fails. You must shift from implicit to explicit communication.","Hire for 'Culture Add', not just 'Culture Fit' to prevent homogeneity.","The Manager's role shifts from Player-Coach to Unblocker-Strategist.","Standardized onboarding is the highest leverage activity for maintaining velocity."],content:`
        ...
        `},{id:2,title:"The ROI of Technical Debt",summary:"A framework for prioritizing refactoring against feature work. Communicating the business value of clean code to stakeholders.",date:"Nov 05, 2025",readTime:"6 min read",slug:"roi-technical-debt",tags:["Strategy","Tech Debt","Management"],icon:t,link:"#",color:"from-amber-500 to-orange-500",keyTakeaways:["Tech debt is a financial instrument: leverage it for speed, but service the interest before it bankrupts you.","Translate code issues into business risk (stability) and opportunity cost (velocity) for stakeholders.","Implement the '20% Tax': Dedicate 20% of every sprint to debt pay-down.","Never ask for permission to refactor; it is part of the job of writing code."],content:`
